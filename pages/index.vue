    ...
    <section class="hero-section">
      ...
      <div class="container hero-content">
        <div class="text-content">
          <h1 class="title">
            {{ copy.heroLine1 }}<br /><span class="highlight">{{
              copy.heroLine2
            }}</span>
          </h1>
          <p class="subtitle">{{ t('homeHeroDesc') }}</p>
          <div class="action-group">
            <NuxtLink to="/collections/electric-scooters" class="btn-main">{{
              t('shopNow')
            }}</NuxtLink>
            <NuxtLink to="/collections/electric-bike" class="btn-secondary">{{
              t('exploreCatalog')
            }}</NuxtLink>
          </div>
        </div>
